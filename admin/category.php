...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_GET['del'])) {
		...
		$_SESSION['delmsg'] = "berhasil dihapus";
	}
								...
								<div class="module-body">
									...
									<?php if (isset($_POST['submit'])) { ?>
										<div class="alert alert-success">
											...
											<strong>Kategori</strong> <?php echo htmlentities($_SESSION['msg']); ?><?php echo htmlentities($_SESSION['msg'] = ""); ?>
										</div>
									<?php } ?>
									...
									<?php if (isset($_GET['del'])) { ?>
										<div class="alert alert-error">
											<button type="button" class="close" data-dismiss="alert">×</button>
											<strong>Kategori</strong> <?php echo htmlentities($_SESSION['delmsg']); ?><?php echo htmlentities($_SESSION['delmsg'] = ""); ?>
										</div>
									<?php } ?>
									...
									<form class="form-horizontal row-fluid" name="Category" method="post">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" placeholder="Masukkan nama kategori" name="category" class="span8 tip" required>
											</div>
										</div>
											...
											?>
												<tr>
													...
													<td>
														...
														<a href="category.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Apakah anda ingin mengahapus kategori ini?')"><i class="icon-remove-sign"></i></a>
													</td>
												</tr>
											<?php $cnt = $cnt + 1;
											} ?>
