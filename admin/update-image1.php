								...
								<div class="module-body">
									...
									<?php if (isset($_POST['submit'])) { ?>
										<div class="alert alert-success">
											...
											<strong>Gambar</strong> <?php echo htmlentities($_SESSION['msg']); ?><?php echo htmlentities($_SESSION['msg'] = ""); ?>
										</div>
									<?php } ?>
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										?>
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Gambar lama</label>
												<div class="controls">
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Gambar baru</label>
												<div class="controls">
