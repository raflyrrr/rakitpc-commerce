...
if (strlen($_SESSION['alogin']) == 0) {
  ...
  if (isset($_POST['submit2'])) {
    ...
    echo "<script>alert('Status pesanan berhasil diupdate');</script>";
    //}
  }
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr height="50">
            <td colspan="2" class="fontkink2" style="padding-left:0px;">
              <div class="fontpink2"> <b>Status Pemesanan</b></div>
            </td>
          ...
          ?>
            ...
            <tr height="20">
              <td class="fontkink1"><b>Tanggal</b></td>
            ...
            <tr height="20">
              <td class="fontkink1"><b>Note:</b></td>
